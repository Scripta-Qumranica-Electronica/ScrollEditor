...
function getPosWithBoundaries(
    ...
    boundingRectMargin: MarginOptions = {}): Position {
    ...
    const topBoundary = boundingRect.top - 56 + marginTop;
...
export const Draggable: DirectiveOptions = {
    ...
    update(el: HTMLElement, binding: DraggableBindings, vnode: VNode, oldVnode: VNode) {
        ...
        function getRectPosition(): Position | undefined {
            ...
            return { left: clientRect.left, top: clientRect.top - 56 };
        }
        ...
        function initializeState(event?: MouseOrTouchEvent): void {
            ...
            const initialPosition = initialRectPositionFromBinding
