    ...
    <div id="scroll-side-menu"  role="tablist">
        <section>
            <b-card no-body class="mb-1">
                ...
                <b-collapse id="accordion-actions" 
                 style="display:block;"
                accordion="my-accordion-side" role="tabpanel">
                    <b-card-body>
...
import ScrollModal from './scroll-modal.vue';

@Component({
    name: 'scroll-menu',
    components: {
        Waiting,
        'scroll-modal': ScrollModal
    }
})
