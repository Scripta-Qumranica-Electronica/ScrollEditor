...
export default class ImagedObjectEditorNewNew
    extends Vue
    ...
    private getArtefactColor(art: Artefact) {
        ...
        return ImagedObjectEditorNewNew.colors[
            idx % ImagedObjectEditorNewNew.colors.length
        ];
    }
