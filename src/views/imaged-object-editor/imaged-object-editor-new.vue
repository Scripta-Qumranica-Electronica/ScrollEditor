...
export default class ImagedObjectEditorNew extends Vue implements SavingAgent<ImagedObjectEditorOperation> {
    ...
    private getArtefactColor(art: Artefact) {
        ...
        return ImagedObjectEditorNew.colors[
            idx % ImagedObjectEditorNew.colors.length
        ];
    }
