...
export interface UpdatedArtefactPlacementDTO
    extends UpdateArtefactPlacementDTO {
...
export interface EditionManuscriptMetricsDTO
    extends UpdateEditionManuscriptMetricsDTO {
    ppi: number;
    editorId: number;
}
...
export interface SetInterpretationRoiDTO
    extends SetReconstructedInterpretationRoiDTO {
    artefactId: number;
...
export interface SignInterpretationVariantDTO
    extends InterpretationAttributeBaseDTO {
    character: string;
}
...
export interface UnactivatedEmailUpdateRequestDTO
    extends ResendUserAccountActivationRequestDTO {
    newEmail: string;
}
...
export interface ResetForgottenUserPasswordRequestDTO
    extends AccountActivationRequestDTO {
    password: string;
}
...
export type SideDesignation = 'recto' | 'verso';
...
export type Lighting = 'direct' | 'raking';
